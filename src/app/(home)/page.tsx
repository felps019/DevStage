...
export default function Home() {
  return (
    <div className="min-h-dvh flex flex-col justify-center gap-16 ">
      ...
      {/* Esse items-stretch faz com que os items estiquem pra ficar do mesmo tamanho*/}
      <div className="flex gap-5 items-stretch flex-col md:flex-row">
        {/* O space da um espacamento entre os items, valido somente para elementos display block */}
